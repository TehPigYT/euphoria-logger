import { Logger, DiscordWebhook, TelegramWebhook, SlackWebhook, GuildedWebhook } from "../src/index.js";
...
const logger = new Logger({
    ...
    types: ["INFO", "DEBUG", "WARN", "ERROR"], // custom types, default is ["DEBUG", "INFO", "SUCCESS", "WARN", "ERROR"]
